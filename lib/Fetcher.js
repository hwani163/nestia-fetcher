...
axiosInstance.interceptors.request.use(function (config) {
    var configHeader = config.headers, restConfig = __rest(config, ["headers"]);
    return __assign({ headers: configHeader }, restConfig);
});
...
function (error) {
    ...
    if (error.config.method.toUpperCase() === "GET") {
        return Promise.reject(__assign(__assign({ error: true }, (_a = error === null || error === void 0 ? void 0 : error.response) === null || _a === void 0 ? void 0 : _a.data), { status: error.response.status, config: error === null || error === void 0 ? void 0 : error.config }));
    }
    else {
        return Promise.resolve({
            data: __assign(__assign({ error: true }, (_b = error === null || error === void 0 ? void 0 : error.response) === null || _b === void 0 ? void 0 : _b.data), { status: error.response.status, config: error === null || error === void 0 ? void 0 : error.config }),
        });
    }
});
/**
...
var Fetcher = /** @class */ (function () {
    ...
    Fetcher.fetch = function (connection, 
    // @ts-ignore
    encrypted, method, _path, input, 
    // @ts-ignore
    stringify) {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        init = {
                            ...
                            url: path,
                            method: method,
                            headers: __assign(__assign({}, connection.headers), { "Content-Type": "application/json" }),
                        };
                        // console.log(init);
