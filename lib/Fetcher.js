...
function (error) {
    ...
    if (error.config.method.toUpperCase() === "GET") {
        ...
        return {
            data: __assign(__assign({}, (_b = error === null || error === void 0 ? void 0 : error.response) === null || _b === void 0 ? void 0 : _b.data), { status: error.response.status, config: error === null || error === void 0 ? void 0 : error.config }),
        };
    }
});
/**
