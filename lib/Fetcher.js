...
axiosInstance.interceptors.response.use(function (response) {
    ...
    var _a;
    return Promise.reject(JSON.stringify(__assign(__assign({}, (_a = error === null || error === void 0 ? void 0 : error.response) === null || _a === void 0 ? void 0 : _a.data), { status: error.response.status })));
});
/**
