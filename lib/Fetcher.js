...
function (error) {
    ...
    if (error.config.method.toUpperCase() === "GET") {
        Promise.reject(__assign(__assign({}, (_a = error === null || error === void 0 ? void 0 : error.response) === null || _a === void 0 ? void 0 : _a.data), { status: error.response.status, config: error === null || error === void 0 ? void 0 : error.config }));
    }
    else {
        Promise.resolve(__assign(__assign({}, (_b = error === null || error === void 0 ? void 0 : error.response) === null || _b === void 0 ? void 0 : _b.data), { status: error.response.status, config: error === null || error === void 0 ? void 0 : error.config }));
    }
});
/**
