...
var Fetcher = /** @class */ (function () {
    ...
    Fetcher.fetch = function (connection, encrypted, method, path, input, stringify) {
        return __awaiter(this, void 0, void 0, function () {
            var init, body_1, response, body, ret;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        //         );
                        console.warn("connection", connection, "encrypted", encrypted, "method", method, "path", path, "input", input);
                        ...
                        return [4 /*yield*/, (0, axios_1.default)(init)];
                    case 1:
                        response = _a.sent();
                        body = response.data;
                        if (!body)
